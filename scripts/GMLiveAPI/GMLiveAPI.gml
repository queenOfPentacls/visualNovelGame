// Generated at 2022-11-14 21:18:21 (1122ms) for v2.3+
/// @lint nullToAny true
// Feather disable all
...
function live_preinit_init_funcs(){
	...
	while(!file_text_eof(l_lines)){
		...
		if(l_isJS){
			gml_func_add(l_sig,l_jsFuncs[l_jsIndex++]);
		} else {
			var l_m=l_fm[?l_name];
...
if(live_enabled)
function live_preinit_js_funcs(){
	var l_dummy=function(){}
	return [
		is_real,
		is_numeric,
		is_string,
...
function live_preinit_init_new_consts(){
	...
	try{
		gml_const_add("network_config_avoid_time_wait",network_config_avoid_time_wait)
	}catch(l__g){
	...
	try{
		gml_const_add("seqtracktype_graphic",seqtracktype_graphic)
	}catch(l__g){
		
	}
	try{
		gml_const_add("seqtracktype_audio",seqtracktype_audio)
	}catch(l__g){
		
	}
	try{
		gml_const_add("seqtracktype_real",seqtracktype_real)
	}catch(l__g){
		
	}
	try{
		gml_const_add("seqtracktype_color",seqtracktype_color)
	}catch(l__g){
		
	}
	try{
		gml_const_add("seqtracktype_colour",seqtracktype_colour)
	}catch(l__g){
		
	}
	try{
		gml_const_add("seqtracktype_bool",seqtracktype_bool)
	}catch(l__g){
		
	}
	try{
		gml_const_add("seqtracktype_string",seqtracktype_string)
	}catch(l__g){
		
	}
	try{
		gml_const_add("seqtracktype_sequence",seqtracktype_sequence)
	}catch(l__g){
		
	}
	try{
		gml_const_add("seqtracktype_clipmask",seqtracktype_clipmask)
	}catch(l__g){
		
	}
	try{
		gml_const_add("seqtracktype_clipmask_mask",seqtracktype_clipmask_mask)
	}catch(l__g){
		
	}
	try{
		gml_const_add("seqtracktype_clipmask_subject",seqtracktype_clipmask_subject)
	}catch(l__g){
		
	}
	try{
		gml_const_add("seqtracktype_group",seqtracktype_group)
	}catch(l__g){
		
	}
	try{
		gml_const_add("seqtracktype_empty",seqtracktype_empty)
	}catch(l__g){
		
	}
	try{
		gml_const_add("seqtracktype_spriteframes",seqtracktype_spriteframes)
	}catch(l__g){
		
	}
	try{
		gml_const_add("seqtracktype_instance",seqtracktype_instance)
	}catch(l__g){
		
	}
	try{
		gml_const_add("seqtracktype_message",seqtracktype_message)
	}catch(l__g){
		
	}
	try{
		gml_const_add("seqtracktype_moment",seqtracktype_moment)
	}catch(l__g){
	...
	try{
		gml_const_add("animcurvetype_linear",animcurvetype_linear)
	}catch(l__g){
		
	}
	try{
		gml_const_add("animcurvetype_catmullrom",animcurvetype_catmullrom)
	}catch(l__g){
