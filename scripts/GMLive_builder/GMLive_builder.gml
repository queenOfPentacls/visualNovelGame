...
function gml_builder(l_pg,l_src)constructor{
	...
	static h_build_expr=function(l_flags){
		...
		switch(l_tk0.__enumIndex__){
			...
			case 14:self.h_out_node=gml_node_number(l_tk0.h_d,l_tk0.h_nu,l_tk0.h_src);break;
			case 15:self.h_out_node=gml_node_cstring(l_tk0.h_d,l_tk0.h_st);break;
			case 22:
				l_proc=true;
				l_sep=true;
			...
			case 11:
				switch(l_tk0.h_kw){
					...
					case 24:
						...
						l_tk=self.h_tokens[self.h_offset];
						if(l_tk.__enumIndex__==24)var l__g1=l_tk.h_d; else return self.h_expect("a `{`",self.h_tokens[self.h_offset]);
						self.h_build_line();
					...
					case 18:
						...
						if(self.h_offset<self.h_length){
							...
							switch(l__g1.__enumIndex__){
								...
								case 25:self.h_out_node=gml_node_exit_hx(l__g1.h_d);break;
								default:
									if(self.h_build_expr(0))return true;
