...
function gml_node_tools_is_in_block(l_q,l_p){
	...
	switch(l__g.__enumIndex__){
		case 92:return true;
		case 93:if(l_q!=l__g.h_then)return l_q==l__g.h_not; else return true;
		case 98:return l_q==l__g.h_node;
		case 100:return l_q==l__g.h_node;
		case 99:return l_q==l__g.h_node;
		case 101:return l_q==l__g.h_node;
		case 102:return (l_q==l__g.h_pre||l_q==l__g.h_post)||l_q==l__g.h_loop;
		case 95:
	...
	switch(l__g.__enumIndex__){
		...
		case 45:
			...
			if(l__g1.__enumIndex__==45){
				var l_b_name=l__g1.h_name;
				var l_b_value=l__g1.h_value;
				return l__g.h_name==l_b_name&&gml_node_tools_equals(l__g.h_value,l_b_value);
			} else return false;
		case 46:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==46)return l__g.h_name==l__g1.h_name; else return false;
		case 47:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==47){
				var l_b_name=l__g1.h_name;
				var l_b_val=l__g1.h_val;
				return l__g.h_name==l_b_name&&gml_node_tools_equals(l__g.h_val,l_b_val);
			} else return false;
		case 48:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==48){
				...
				var l_b_op=l__g1.h_op;
				var l_b_val=l__g1.h_val;
				return l__g.h_name==l_b_name&&l__g.h_op==l_b_op&&gml_node_tools_equals(l__g.h_val,l_b_val);
			} else return false;
		case 49:
			var l__g1=l_b;
		...
		case 55:
			var l__g1=l_b;
			if(l__g1.__enumIndex__==55)return l__g.h_v==l__g1.h_v; else return false;
		case 56:
			var l__g1=l_b;
		...
		case 111:
			var l__g=l_b;
			if(l__g.__enumIndex__==111)return gml_node_tools_equals(l__g.h_x,l__g.h_x); else return false;
		case 17:
			var l__g1=l_b;
...
function gml_node_tools_clone(l_q){
	...
	switch(l__g.__enumIndex__){
		...
		case 45:return gml_node_static_decl(l_d,l__g.h_name,gml_node_tools_clone(l__g.h_value));
		case 46:return gml_node_static(l_d,l__g.h_name);
		case 47:return gml_node_static_set(l_d,l__g.h_name,gml_node_tools_clone(l__g.h_val));
		case 48:return gml_node_static_aop(l_d,l__g.h_name,l__g.h_op,gml_node_tools_clone(l__g.h_val));
		case 49:return gml_node_global_hx(l_d,l__g.h_id);
		case 50:return gml_node_global_set(l_d,l__g.h_id,gml_node_tools_clone(l__g.h_val));
		case 51:return gml_node_global_aop(l_d,l__g.h_id,l__g.h_op,gml_node_tools_clone(l__g.h_val));
		case 52:return gml_node_field(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_fd);
		case 53:return gml_node_field_set(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_fd,gml_node_tools_clone(l__g.h_val));
		case 54:return gml_node_field_aop(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_fd,l__g.h_op,gml_node_tools_clone(l__g.h_val));
		case 55:return gml_node_env(l_d,l__g.h_v);
		case 56:return gml_node_env_set(l_d,l__g.h_v,gml_node_tools_clone(l__g.h_val));
		case 57:return gml_node_env_aop(l_d,l__g.h_v,l__g.h_op,gml_node_tools_clone(l__g.h_val));
		case 58:return gml_node_env_fd(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_av);
		case 59:return gml_node_env_fd_set(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_av,gml_node_tools_clone(l__g.h_v));
		case 60:return gml_node_env_fd_aop(l_d,gml_node_tools_clone(l__g.h_x),l__g.h_av,l__g.h_op,gml_node_tools_clone(l__g.h_v));
		case 61:return gml_node_env1d(l_d,l__g.h_v,gml_node_tools_clone(l__g.h_k));
		case 62:return gml_node_env1d_set(l_d,l__g.h_v,gml_node_tools_clone(l__g.h_k),gml_node_tools_clone(l__g.h_val));
		case 63:return gml_node_env1d_aop(l_d,l__g.h_v,gml_node_tools_clone(l__g.h_k),l__g.h_op,gml_node_tools_clone(l__g.h_val));
		case 64:return gml_node_alarm(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i));
		case 65:return gml_node_alarm_set_hx(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),gml_node_tools_clone(l__g.h_v));
		case 66:return gml_node_alarm_aop(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i),l__g.h_op,gml_node_tools_clone(l__g.h_v));
		case 67:return gml_node_index(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_id));
		case 68:return gml_node_index_set(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_id),gml_node_tools_clone(l__g.h_v));
		case 69:return gml_node_index_aop(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_id),l__g.h_o,gml_node_tools_clone(l__g.h_v));
		case 70:return gml_node_index2d(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i1),gml_node_tools_clone(l__g.h_i2));
		case 71:return gml_node_index2d_set(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i1),gml_node_tools_clone(l__g.h_i2),gml_node_tools_clone(l__g.h_v));
		case 72:return gml_node_index2d_aop(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_i1),gml_node_tools_clone(l__g.h_i2),l__g.h_o,gml_node_tools_clone(l__g.h_v));
		case 73:return gml_node_raw_id(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_id));
		case 74:return gml_node_raw_id_set(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_id),gml_node_tools_clone(l__g.h_v));
		case 75:return gml_node_raw_id_aop(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_id),l__g.h_o,gml_node_tools_clone(l__g.h_v));
		...
		case 79:return gml_node_ds_list(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_id));
		case 80:return gml_node_ds_list_set_hx(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_id),gml_node_tools_clone(l__g.h_v));
		case 81:return gml_node_ds_list_aop(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_id),l__g.h_o,gml_node_tools_clone(l__g.h_v));
		case 82:return gml_node_ds_map(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_id));
		case 83:return gml_node_ds_map_set_hx(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_id),gml_node_tools_clone(l__g.h_v));
		case 84:return gml_node_ds_map_aop(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_id),l__g.h_o,gml_node_tools_clone(l__g.h_v));
		case 85:return gml_node_ds_grid(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_i1),gml_node_tools_clone(l__g.h_i2));
		case 86:return gml_node_ds_grid_set_hx(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_i1),gml_node_tools_clone(l__g.h_i2),gml_node_tools_clone(l__g.h_v));
		case 87:return gml_node_ds_grid_aop(l_d,gml_node_tools_clone(l__g.h_lx),gml_node_tools_clone(l__g.h_i1),gml_node_tools_clone(l__g.h_i2),l__g.h_o,gml_node_tools_clone(l__g.h_v));
		case 88:return gml_node_key_id(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_id));
		case 89:return gml_node_key_id_set(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_id),gml_node_tools_clone(l__g.h_v));
		case 90:return gml_node_key_id_aop(l_d,gml_node_tools_clone(l__g.h_x),gml_node_tools_clone(l__g.h_id),l__g.h_o,gml_node_tools_clone(l__g.h_v));
		...
		case 98:return gml_node_while_hx(l_d,gml_node_tools_clone(l__g.h_cond),gml_node_tools_clone(l__g.h_node));
		...
		case 101:return gml_node_repeat_hx(l_d,gml_node_tools_clone(l__g.h_times),gml_node_tools_clone(l__g.h_node));
		case 102:return gml_node_for_hx(l_d,gml_node_tools_clone(l__g.h_pre),gml_node_tools_clone(l__g.h_cond),gml_node_tools_clone(l__g.h_post),gml_node_tools_clone(l__g.h_loop));
		case 103:return gml_node_with_hx(l_d,gml_node_tools_clone(l__g.h_ctx),gml_node_tools_clone(l__g.h_node));
		case 104:return gml_node_once(l_d,gml_node_tools_clone(l__g.h_node));
		case 105:return gml_node_return_hx(l_d,gml_node_tools_clone(l__g.h_v));
		case 106:return gml_node_exit_hx(l_d);
		case 107:return gml_node_break_hx(l_d);
		case 108:return gml_node_continue_hx(l_d);
		...
		case 111:return gml_node_throw_hx(l_d,gml_node_tools_clone(l__g.h_x));
...
function gml_node_tools_seek_all(l_q,l_st,l_c){
	...
	switch(l__g.__enumIndex__){
		...
		case 45:l_r=l_c(l__g.h_value,undefined);break;
		...
		case 56:l_r=l_c(l__g.h_val,undefined);break;
		case 57:l_r=l_c(l__g.h_val,undefined);break;
		...
		case 41:
			...
			break;
		case 61:l_r=l_c(l__g.h_k,undefined);break;
		case 62:
			var l_l_k=l__g.h_k;
			var l_l_val=l__g.h_val;
		...
		case 54:
			...
			l_r=l_c(l_l_x,undefined)||l_c(l_l_val,undefined);
			break;
		case 58:l_r=l_c(l__g.h_x,undefined);break;
		case 59:
			var l_l_x=l__g.h_x;
			var l_l_v=l__g.h_v;
...
function gml_node_tools_seek(l_q,l_st,l_c){
	...
	switch(l__g.__enumIndex__){
		...
		case 45:l_r=l_c(l__g.h_value,l_st);break;
		case 46:l_r=false;break;
		case 47:l_r=l_c(l__g.h_val,l_st);break;
		case 48:l_r=l_c(l__g.h_val,l_st);break;
		case 49:l_r=false;break;
		...
		case 54:
			...
			break;
		case 55:l_r=false;break;
		case 56:l_r=l_c(l__g.h_val,l_st);break;
		case 57:l_r=l_c(l__g.h_val,l_st);break;
		case 58:l_r=l_c(l__g.h_x,l_st);break;
		case 59:
			var l_l_x=l__g.h_x;
			var l_l_v=l__g.h_v;
		...
		case 60:
			...
			l_r=l_c(l_l_x,l_st)||l_c(l_l_v,l_st);
			break;
		case 61:l_r=l_c(l__g.h_k,l_st);break;
		case 62:
			var l_l_k=l__g.h_k;
			var l_l_val=l__g.h_val;
