...
function gml_compile_node(l_q,l_actions,l_out){
	...
	switch(l__g.__enumIndex__){
		...
		case 41:
			...
			break;
		case 49:ds_list_add(l_actions,gml_action_global_hx(l__g.h_d,l__g.h_id));break;
		case 50:
			if(gml_compile_node(l__g.h_val,l_actions,true))return true;
		...
		case 52:
			...
			switch(l__g1.__enumIndex__){
				case 13:if(l_fastGetter!=undefined)ds_list_add(l_actions,gml_action_fast_self_field(l__g.h_d,l_fastGetter)); else ds_list_add(l_actions,gml_action_self_field(l__g.h_d,l_s));break;
				case 42:
		...
		case 66:
			...
			break;
		case 55:ds_list_add(l_actions,gml_action_env(l__g.h_d,l__g.h_v.h_func));break;
		case 56:
			var l_av=l__g.h_v;
			if(gml_compile_node(l__g.h_val,l_actions,true))return true;
		...
		case 97:ds_list_add(l_actions,gml_action_fork(l__g.h_d,l_out));break;
