			...
			switch(l_c){
				...
				default:
					if(l_c>=97&&l_c<=122||l_c>=65&&l_c<=90||l_c==95){
						...
						switch(l_s){
							case "global":
								var l_tk90=gml_token_keyword(l_d,0);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk90); else ds_list_add(l_out,l_tk90);
								break;
							case "true":
								var l_tk105=gml_token_number(l_d,1,undefined);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk105); else ds_list_add(l_out,l_tk105);
								break;
							case "false":
								var l_tk86=gml_token_number(l_d,0,undefined);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk86); else ds_list_add(l_out,l_tk86);
								break;
							case "all":
								var l_tk67=gml_token_number(l_d,-3,undefined);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk67); else ds_list_add(l_out,l_tk67);
								break;
							case "noone":
								var l_tk96=gml_token_number(l_d,-4,undefined);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk96); else ds_list_add(l_out,l_tk96);
								break;
							case "undefined":
								var l_tk108=gml_token_undefined_hx(l_d);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk108); else ds_list_add(l_out,l_tk108);
								break;
							case "begin":
								var l_tk71=gml_token_cub_open(l_d);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk71); else ds_list_add(l_out,l_tk71);
								break;
							case "end":
								var l_tk83=gml_token_cub_close(l_d);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk83); else ds_list_add(l_out,l_tk83);
								break;
							case "globalvar":
								var l_tk91=gml_token_keyword(l_d,1);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk91); else ds_list_add(l_out,l_tk91);
								break;
							case "var":
								var l_tk110=gml_token_keyword(l_d,2);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk110); else ds_list_add(l_out,l_tk110);
								break;
							case "enum":
								var l_tk84=gml_token_keyword(l_d,3);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk84); else ds_list_add(l_out,l_tk84);
								break;
							case "if":
								var l_tk92=gml_token_keyword(l_d,4);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk92); else ds_list_add(l_out,l_tk92);
								break;
							case "then":
								var l_tk102=gml_token_keyword(l_d,5);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk102); else ds_list_add(l_out,l_tk102);
								break;
							case "else":
								var l_tk82=gml_token_keyword(l_d,6);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk82); else ds_list_add(l_out,l_tk82);
								break;
							case "switch":
								var l_tk101=gml_token_keyword(l_d,7);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk101); else ds_list_add(l_out,l_tk101);
								break;
							case "case":
								var l_tk73=gml_token_keyword(l_d,8);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk73); else ds_list_add(l_out,l_tk73);
								break;
							case "default":
								var l_tk77=gml_token_keyword(l_d,9);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk77); else ds_list_add(l_out,l_tk77);
								break;
							case "for":
								var l_tk87=gml_token_keyword(l_d,14);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk87); else ds_list_add(l_out,l_tk87);
								break;
							case "repeat":
								var l_tk99=gml_token_keyword(l_d,10);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk99); else ds_list_add(l_out,l_tk99);
								break;
							case "while":
								var l_tk111=gml_token_keyword(l_d,11);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk111); else ds_list_add(l_out,l_tk111);
								break;
							case "do":
								var l_tk81=gml_token_keyword(l_d,13);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk81); else ds_list_add(l_out,l_tk81);
								break;
							case "until":
								var l_tk109=gml_token_keyword(l_d,12);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk109); else ds_list_add(l_out,l_tk109);
								break;
							case "with":
								var l_tk112=gml_token_keyword(l_d,15);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk112); else ds_list_add(l_out,l_tk112);
								break;
							case "exit":
								var l_tk85=gml_token_keyword(l_d,19);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk85); else ds_list_add(l_out,l_tk85);
								break;
							case "return":
								var l_tk100=gml_token_keyword(l_d,18);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk100); else ds_list_add(l_out,l_tk100);
								break;
							case "break":
								var l_tk72=gml_token_keyword(l_d,17);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk72); else ds_list_add(l_out,l_tk72);
								break;
							case "continue":
								var l_tk76=gml_token_keyword(l_d,16);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk76); else ds_list_add(l_out,l_tk76);
								break;
							case "try":
								if(l_ver.h_has_try_catch){
									var l_tk106=gml_token_keyword(l_d,21);
									if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk106); else ds_list_add(l_out,l_tk106);
								} else {
									var l_tk107=gml_token_ident(l_d,l_s);
									if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk107); else ds_list_add(l_out,l_tk107);
								}
								break;
							case "catch":
								if(l_ver.h_has_try_catch){
									var l_tk74=gml_token_keyword(l_d,22);
									if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk74); else ds_list_add(l_out,l_tk74);
								} else {
									var l_tk75=gml_token_ident(l_d,l_s);
									if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk75); else ds_list_add(l_out,l_tk75);
								}
								break;
							case "throw":
								if(l_ver.h_has_try_catch){
									var l_tk103=gml_token_keyword(l_d,23);
									if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk103); else ds_list_add(l_out,l_tk103);
								} else {
									var l_tk104=gml_token_ident(l_d,l_s);
									if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk104); else ds_list_add(l_out,l_tk104);
								}
								break;
							case "new":
								if(l_ver.h_has_constructor){
									var l_tk94=gml_token_keyword(l_d,25);
									if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk94); else ds_list_add(l_out,l_tk94);
								} else {
									var l_tk95=gml_token_ident(l_d,l_s);
									if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk95); else ds_list_add(l_out,l_tk95);
								}
								break;
							case "delete":
								if(l_ver.h_has_delete){
									var l_tk78=gml_token_keyword(l_d,29);
									if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk78); else ds_list_add(l_out,l_tk78);
								} else {
									var l_tk79=gml_token_ident(l_d,l_s);
									if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk79); else ds_list_add(l_out,l_tk79);
								}
								break;
							case "function":
								if(l_ver.h_has_func_literal){
									var l_tk88=gml_token_keyword(l_d,24);
									if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk88); else ds_list_add(l_out,l_tk88);
								} else {
									var l_tk89=gml_token_ident(l_d,l_s);
									if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk89); else ds_list_add(l_out,l_tk89);
								}
								break;
							case "div":
								var l_tk80=gml_token_bin_op(l_d,3);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk80); else ds_list_add(l_out,l_tk80);
								break;
							case "mod":
								var l_tk93=gml_token_bin_op(l_d,2);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk93); else ds_list_add(l_out,l_tk93);
								break;
							case "and":
								var l_tk68=gml_token_bin_op(l_d,80);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk68); else ds_list_add(l_out,l_tk68);
								break;
							case "or":
								var l_tk98=gml_token_bin_op(l_d,96);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk98); else ds_list_add(l_out,l_tk98);
								break;
							case "xor":
								var l_tk113=gml_token_bin_op(l_d,65);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk113); else ds_list_add(l_out,l_tk113);
								break;
							case "not":
								var l_tk97=gml_token_un_op(l_d,1);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk97); else ds_list_add(l_out,l_tk97);
								break;
							case "argument":
								var l_tk69=gml_token_keyword(l_d,26);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk69); else ds_list_add(l_out,l_tk69);
								break;
							case "argument_count":
								var l_tk70=gml_token_keyword(l_d,27);
							...
							default:
								if(gml_std_StringTools_startsWith(l_s,"argument")){
									...
									if(string_digits(l_s_8)==l_s_8){
										var l_tk114=gml_token_arg_const(l_d,gml_std_Std_parseInt(l_s_8));
										if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk114); else ds_list_add(l_out,l_tk114);
									} else {
										var l_tk115=gml_token_ident(l_d,l_s);
										if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk115); else ds_list_add(l_out,l_tk115);
									}
								} else {
									var l_tk116=gml_token_ident(l_d,l_s);
									if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk116); else ds_list_add(l_out,l_tk116);
								}
						}
						...
						if(buffer_peek(l_buf,l_pos,buffer_u8)==120){
							...
							var l_tk117=gml_token_number(l_d,l_i,gml_parser_buf_sub(l_buf,l_sub_buf,l_start,l_pos));
							if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk117); else ds_list_add(l_out,l_tk117);
						} else {
							l_pos--;
							l_z=false;
							l_s=undefined;
								...
								if(l_c==46){
									if(l_z){
										...
										if(l_c==95||l_c>=97&&l_c<=122||l_c>=65&&l_c<=90){
											...
											var l_tk118=gml_token_number(l_d,gml_std_Std_parseFloat(l_s),l_s);
											if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk118); else ds_list_add(l_out,l_tk118);
											l_d=new gml_pos(l_src,l_row,l_pos-l_rowStart);
											var l_tk119=gml_token_period(l_d);
											if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk119); else ds_list_add(l_out,l_tk119);
											break;
										}
										l_z=true;
									}
							...
							if(l_s==undefined){
								...
								var l_tk120=gml_token_number(l_d,l_f,l_s);
								if(l__gthis.h_curr_macro!=undefined)array_push(l__gthis.h_curr_macro.h_tokens,l_tk120); else ds_list_add(l_out,l_tk120);
							}
						}
					} else {
