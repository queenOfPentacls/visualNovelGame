...
// Feather disable all
// Generated at 2022-11-14 22:10:17 (11483ms) for v2.3.7+
/// @lint nullToAny true
// Feather disable all
...
function compile_groups_gml_compile_group_local_proc(l_q,l_actions,l_out){
	...
	switch(l__g.__enumIndex__){
		...
		case 45:
			...
			if(gml_compile_node(l__g.h_value,l_actions,true))return true;
			...
			break;
		case 46:ds_list_add(l_actions,vm_v2_gml_action_closure_bind(l__g.h_d,"static[]",{ind:gml_compile_curr_script.h_static_map.h_obj[$ l__g.h_name],values:gml_compile_curr_script.h_static_values},compile_groups_gml_compile_group_local_proc_lf22));break;
		case 47:
			var l_d=l__g.h_d;
			if(gml_compile_curr_script.h_is_constructor)return compile_groups_gml_compile_group_local_no_static_writes(l_d);
...
function compile_gml_compile_delete_proc(l_actions,l_d,l_x){
	...
	switch(l__g.__enumIndex__){
		case 42:
			...
			break;
		case 49:ds_list_add(l_actions,vm_v2_gml_action_closure_bind(l_d,"delete global",{varname:l__g.h_id},compile_gml_compile_delete_proc_lf1));break;
		case 52:
			var l__g1=l__g.h_x;
	...
	if(l__g.__enumIndex__==22){
		...
		switch(l__g.__enumIndex__){
			case 16:
				...
				break;
			case 52:gml_std_haxe_enum_tools_setTo(l_q,gml_node_call_field(l_d,l__g.h_x,l__g.h_fd,l_args1));break;
			case 12:
				var l_s1=l__g.h_id;
			...
			if(ds_list_size(l_st)>0){
				...
				switch(l__g.__enumIndex__){
					case 67:
						...
						break;
					case 70:return gml_program_seek_inst.h_error("`"+l_s+"` is not a 2d array.",l__g.h_d);
...
function vm_v2_gml_thread_group_func_literal_create_function(l_program,l__name,l__self){
	...
	if(l_program.h_script_map.h_obj[$ l__name].h_is_constructor)return method(l_meta,vm_v2_gml_thread_group_func_literal_ctr_impl); else return method(l_meta,gml_thread_method_script);
}
